...
import '../../../bloc/adding_events.dart';
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          BlocBuilder<AddingEventsCubit, bool>(builder: (context, v) {
                            return SizedBox(
                              height: 30,
                              width: 30,
                              child: v
                    ...
                    TableCalendar(
                      ...
                      headerStyle: HeaderStyle(
                          ...
                          titleTextStyle: TextStyle(
                              fontSize: 16, fontWeight: FontWeight.bold, color: Colors.blueGrey.withOpacity(0.7)),
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: Text(
                                    day.day.toString(),
                                    style: const TextStyle(
                                        color: Color(0xff541675), fontSize: 16, fontWeight: FontWeight.w900),
                                  ),
                                ),
                              ),
                            );
                            ...
                            return Container(
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: Text(
                                    day.day.toString(),
                                    style: const TextStyle(color: Color(0xff541675), fontSize: 16),
                                  ),
                                ),
                              ),
                            );
